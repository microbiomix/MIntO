...
parser = add_option(parser, c("-i", "--input"), type="character", default=NULL, help="files to be combined; as one comma-delimited string [primary input]")
parser = add_option(parser, c("-f", "--filelist"), type="character", default=NULL, help="files to be combined in a list, one per line [skipped when --input is provided]")
